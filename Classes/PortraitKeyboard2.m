...
@implementation PortraitKeyboard2
...
-(void)save
{
    ...
    fileName=[NSString stringWithFormat:@"%@/portraitTypeTestAtTime%@.txt", documentsDirectory,str];
...
-(void)saveToFile;
{
    ...
    fileName2=[NSString stringWithFormat:@"%@/portraitTouchTrack%@.plist", documentsDirectory2,str];
    // write data to file
